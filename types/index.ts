...
export interface ReportEvidence { documentId: string; flaggedRegions: string[]; verdict: string; recommendation: ReviewDecision }
export interface RingEntity { id: string; name: string; type: 'vendor' | 'account' | 'address' | 'fingerprint'; risk: number }
